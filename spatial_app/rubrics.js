// rubrics.js
// Browser-friendly ES module version of rubrics.py exports

export const spatial_words = [
...
// Your HTML expects rubric3 to interpolate into a string prompt.
// Exporting it as a formatted JSON string avoids "[object Object]" issues.
export const rubric3 = JSON.stringify(rubric3_obj, null, 2);

// Optional exports (not used by your current HTML, but kept for parity with rubrics.py)
export const rubric2 = [
  {
    rubric_name: "Spatial Language Use Rubric",
    levels: [
      {
        description: "Basic Spatial Language Use",
        criteria: "Uses simple spatial terms and concepts in conversation.",
        example: "The book is on the table."
      },
      {
        description: "Intermediate Spatial Language Use",
        criteria: "Incorporates spatial relationships and directions in conversation.",
        example: "The park is north of the library, and the cafe is to the east."
      },
      {
        description: "Advanced Spatial Language Use",
        criteria: "Utilizes complex spatial reasoning and multi-step directions.",
        example: "To get to the museum, go past the library, take a left at the second intersection, and it's the third building on your right."
      },
      {
        description: "Expert Spatial Language Use",
        criteria: "Demonstrates sophisticated spatial reasoning with abstract concepts and hypothetical scenarios.",
        example: "Imagine a cube rotating in space; describe the position of each face relative to the others."
      }
    ],
    Appendix: [
      {
        description: "Noun",
        conditions: [
          { description: "Nouns can be spatial when they refer to locations or objects in space.", example: "The mountain is visible from here." }
        ]
      },
      {
        description: "Pronoun",
        conditions: [
          { description: "Pronouns can be spatial when they replace spatial nouns.", example: "It is over there." }
        ]
      },
      {
        description: "Adjective",
        conditions: [
          { description: "Adjectives can be spatial when they describe spatial properties.", example: "The tall building is next to the park." }
        ]
      },
      {
        description: "Determiner",
        conditions: [
          { description: "Determiners can be spatial when they specify spatial nouns.", example: "This road leads to the city." }
        ]
      },
      {
        description: "Verb",
        conditions: [
          { description: "Verbs can be spatial when they describe movement or position.", example: "The car moved forward." }
        ]
      },
      {
        description: "Adverb",
        conditions: [
          { description: "Adverbs can be spatial when they modify verbs with spatial context.", example: "He walked outside." }
        ]
      },
      {
        description: "Preposition",
        conditions: [
          { description: "Prepositions are inherently spatial as they describe relationships between objects.", example: "The cat is under the table." }
        ]
      },
      {
        description: "Conjunction",
        conditions: [
          { description: "Conjunctions are not typically spatial but can connect spatial clauses.", example: "The house is large, and it is on the hill." }
        ]
      },
      {
        description: "Interjection",
        conditions: [
          { description: "Interjections are not spatial but can express spatial surprise or realization.", example: "Wow, look at that view!" }
        ]
      }
    ]
  }
